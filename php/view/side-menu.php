    ...
    <div class="nav-wrapper">
        ...
        <nav>
            ...
            <ul class="nav-social-media">
                <li><a class="btn btn-nav theme-secondary" href="https://www.linkedin.com/in/ggrundell/"
                        target="_blank"><span class="icon-linkedin"></span></a></li>
                <li><a class="btn btn-nav theme-secondary" href="https://twitter.com/PersonalHeff" target="_blank"><span
                            class="icon-x"></span></a></li>
            </ul>
        </nav>
    </div>
</aside>